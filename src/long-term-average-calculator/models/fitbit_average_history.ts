...
export type FitbitAverageHistoryId = FitbitAverageHistory[FitbitAverageHistoryPk];
export type FitbitAverageHistoryOptionalAttributes = "id" | "avg_steps" | "avg_calories_total" | "avg_distance_km" | "avg_heart_rate" | "avg_resting_heart_rate" | "avg_activity_duration" | "avg_sedentary_minutes" | "avg_lightly_active_minutes" | "avg_fairly_active_minutes" | "avg_very_active_minutes" | "avg_total_sleep_hours" | "avg_deep_sleep_hours" | "avg_light_sleep_hours" | "avg_rem_sleep_hours" | "avg_awake_hours" | "avg_sleep_heart_rate" | "avg_hrv" | "avg_rhr" | "avg_respiratory_rate" | "avg_skin_temperature" | "avg_stress_score" | "avg_total_score" | "updated_at" | "created_at" | "avg_activity_score" | "avg_metrics_score";
export type FitbitAverageHistoryCreationAttributes = Optional<FitbitAverageHistoryAttributes, FitbitAverageHistoryOptionalAttributes>;

export class FitbitAverageHistory extends Model<FitbitAverageHistoryAttributes, FitbitAverageHistoryCreationAttributes> implements FitbitAverageHistoryAttributes {
  id!: number;
  user_id!: number;
  recorded_at!: string;
  period_type!: '30D' | '90D' | '180D' | '360D';
  ...
  static initModel(sequelize: Sequelize.Sequelize): typeof FitbitAverageHistory {
