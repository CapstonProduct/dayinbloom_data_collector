  ...
  implements FitbitSleepDataAttributes
{
  ...
  declare total_sleep_minutes: number;
  declare deep_sleep_hours: number;
  declare light_sleep_hours: number;
  declare rem_sleep_hours: number;
  declare minutesAwake: number;
  declare awakeningsCount?: number;
  declare awakeCount: number;
  declare awakeDuration?: number;
  declare restlessCount: number;
  declare restlessDuration?: number;
  declare logId?: number;
  declare timeinBed?: number;
  declare minutesAsleep?: number;
  declare efficiency: number;
  declare duration: number;
  declare quality: number;
  declare isMainSleep: boolean;
